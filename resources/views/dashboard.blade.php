...
<div class="grid space-y-5">
        ...
        <div>
            <button class="py-2 px-5 bg-flag-green  rounded-md text-white">
                Share File
            </button>
        </div>
    </div>
        ...
        <div class="bg-gray-100 p-6 rounded-xl shadow">
            <span class="rounded-full   bg-black">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M17 13.4H13.8C11.4 13.4 10.6 12.6 10.6 10.2V7L17 13.4Z" stroke="#5F6D7E" stroke-width="2"
            ...
            <h2 class="text-lg font-bold mb-2">28</h2>
            <p class="text-sm text-black">New Files</p>
        </div>
        <div class="bg-gray-100 p-6 rounded-xl shadow">
            <span class="rounded-full   bg-black">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 class="text-lg font-bold mb-2">28</h2>
            <p class="text-sm text-black">New Rejected Files</p>
        </div>
        <div class="bg-gray-100 p-6 rounded-xl shadow">
            <span class="rounded-full   bg-black">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 class="text-lg font-bold mb-2">28</h2>
            <p class="text-sm text-black">New Accepted Files</p>
        </div>
        <div class="bg-gray-100 p-6 rounded-xl shadow">
            <span class="rounded-full   bg-black">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 class="text-lg font-bold mb-2">28</h2>
            <p class="text-sm text-black">Pending Files</p>
        </div>
    </div>
</div>
